...
public final class NationalFrame extends JFrame
{
    ...
    public static class ScreenCenter
    {
        ...
        public ScreenCenter(NationalFrame java_national_frame)
        {
    ...
    public static class ScreenSizeWidth
    {
        ...
        public ScreenSizeWidth(NationalFrame java_national_frame)
        {
            Dimension screen_size = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public static class ScreenSizeHeight
    {
        ...
        public ScreenSizeHeight(NationalFrame java_national_frame)
        {
            Dimension screen_size = Toolkit.getDefaultToolkit().getScreenSize();
